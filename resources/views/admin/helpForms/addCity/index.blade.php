...
@section('content')
    ...
    <header class="w3-container" style="padding-top:22px">
        <h5 class="w3-xxlarge"><b class="w3-right-align"><i class="fa fa-building" aria-hidden="true"></i> النماذج المساعدة - إضافة مدينة </b><a
                href="{{ route('admin.helpForms.addCity.create') }}" class="w3-left"><i class="fa fa-plus"></i></a></h5>
    </header>
            ...
            <div class="w3-responsive">
                ...
                <p>
                    <input oninput="w3.filterHTML('#id01', '.item', this.value)" class="w3-input"
                        placeholder="أبحث في جدول المدن بواسطة المعرف || العنوان || الوصف">
                </p>
