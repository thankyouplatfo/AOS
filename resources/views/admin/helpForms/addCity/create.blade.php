    ...
    <div class="w3-container w3-large">
        ...
        <div class="w3-bar" style="margin-top: 44px">
            <div class="w3-bar-item w3-right">
                <h1 class="fa-2x" style="padding: 0px;margin:0px;"> أضف مدينة جديدا باسم <span id="main-title"
        ...
        <form action="{{ route('admin.helpForms.addCity.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
            <p>
            ...
            <p>
                ...
                <select class="w3-input add_countrie_id" name="add_countrie_id" id="add_countrie_id" minlength="3"
                    maxlength="40" value="{{ old('add_countrie_id') }}" multiple>
