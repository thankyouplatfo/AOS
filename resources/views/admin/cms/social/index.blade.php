...
@section('content')
    ...
    <header class="w3-container" style="padding-top:22px">
        <h5 class="w3-xxlarge"><b><i class="fa fa-facebook" aria-hidden="true"></i> التواصل الإجتماعي</b><a
                href="{{ route('admin.cms.social.create') }}" class="w3-left"><i class="fa fa-plus"></i></a></h5>
    </header>
                ...
                <table id="id01" class="w3-table w3-striped w3-white w3-centered w3-bordered">
                    ...
                    @foreach ($social as $social)
                        <tr class="item">
                            ...
                            <td>
                                <a href="{{ $social->url }}"><i class="{{ $social->icon }}" title="{{ $social->title }}"></i></a>
                            </td>                            
                            <td>
                                في اخر اي صفحة في الموقع
                            </td>
                            <td>
                                <a href="{{ route('admin.cms.social.edit', $social) }}"
                                    class=" w3-hover-none w3-button w3-bar-item"><i
                                        class="w3-xlarge fa fa-edit cnsb-hov-txt-blue"></i></a>
                            </td>
                            <td>
                                <form action="{{ route('admin.cms.social.destroy', $social) }}" method="post">@csrf<button
