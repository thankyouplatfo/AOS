...
<div class="w3-container w3-large">
    ...
    <form action="{{ route('admin.cms.homePage.addMember.store') }}" method="POST" enctype="multipart/form-data">
        @csrf
        <p>
            <label for="image">صورة</label>
            <input type="file" class="w3-input image" name="image" id="image" value="{{old('image')}}" accept="image/*">
            @error('image')
                {{$message}}
            @enderror
        </p>
        <p>
            ...
            <input type="text" class="w3-input alt" name="alt" id="alt" value="{{old('alt')}}" minlength="3" max="881">
            @error('alt')
                {{$message}}
            @enderror
        </p>
		<p>
            ...
            <input type="text" class="w3-input name" name="name" id="name" minlength="3" maxlength="40" value="{{old('name')}}" oninput="$('#slug').val($('#name').val().replace(/\s+|_+/g,'-').toLowerCase()); $('#main-title').text($('#name').val())">
            @error('name')
                {{$message}}
            @enderror
        </p>
		<p>
            ...
            <input type="hidden" class="w3-input slug" name="slug" id="slug" minlength="3" maxlength="40" value="{{old('slug')}}">
            @error('slug')
                {{$message}}
            @enderror
        </p>
        ...
        <p>
            ...
            <input type="keywords" class="w3-input keywords" name="keywords" id="keywords" minlength="3" maxlength="881" value="{{old('keywords')}}">
            @error('keywords')
                {{$message}}
            @enderror
        </p>
		<p>
            ...
            <input type="email" class="w3-input email" name="email" id="email" minlength="3" maxlength="40" value="{{old('email')}}">
            @error('email')
                {{$message}}
            @enderror
        </p>
		<p>
            ...
            <input type="tel" class="w3-input tel" name="tel" id="tel" minlength="3" maxlength="40" value="{{old('tel')}}">
            @error('tel')
                {{$message}}
            @enderror
        </p>
		...
		<p>
            ...
            <input type="url" class="w3-input facebookAccount" name="facebookAccount" id="facebookAccount" minlength="3" maxlength="40" value="{{old('facebookAccount')}}">
		...
		<p>
            ...
            <input type="url" class="w3-input twitterAccount" name="twitterAccount" id="twitterAccount" minlength="3" maxlength="40" value="{{old('twitterAccount')}}">
		...
		<p>
            ...
            <input type="url" class="w3-input instagramAccount" name="instagramAccount" id="instagramAccount" minlength="3" maxlength="40" value="{{old('instagramAccount')}}">
